...
HD_PWD='E:/vivadoProjects/APS/APS.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log tb_riscv_unit.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source tb_riscv_unit.tcl -notrace
